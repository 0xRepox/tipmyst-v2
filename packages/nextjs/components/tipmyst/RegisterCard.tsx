...
export function RegisterCard({ registerCreator, isProcessing, isRegistered, address }: Props) {
  ...
  const canRegister = Boolean(name.trim() && !isProcessing);
  ...
  return (
    <div className="premium-card space-y-5">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        />
        <p className="text-xs text-white/30">Auto-generated from your address · paste a URL below to override</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            placeholder="https://… (optional, leave blank for auto-avatar)"
            className="premium-input"
          />
        </div>
      </div>
